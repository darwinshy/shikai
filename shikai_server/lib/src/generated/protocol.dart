...
import 'package:shikai_server/src/generated/anime.dart' as _i3;
import 'package:serverpod/protocol.dart' as _i4;
export 'anime.dart'; // ignore_for_file: equal_keys_in_map
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == List<_i3.Anime>) {
      return (data as List).map((e) => deserialize<_i3.Anime>(e)).toList()
          as dynamic;
    }
    try {
